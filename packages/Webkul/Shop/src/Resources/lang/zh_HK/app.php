...
return [
    'customers' => [
        ...
        'account' => [
            ...
            'rma' => [
                ...
                'view' => [
                    'id' => 'RMA 編號',
                    'enter-message' => '在此輸入您的消息',
                    'add-attachments' => '添加附件',
                    'send-message-btn' => '發送消息',
                    'attachment' => '附件',
                    'download' => '下載',
    ...
    'home' => [
        ...
        'index' => [
            ...
            'verify-email' => '驗證您的郵箱賬户',
        ],

        'thanks-for-contact' => '感謝您與我們聯繫，提供您的意見和問題。我們會盡快回復您。',
    ],
    ...
    'emails' => [
        ...
        'customers' => [
            'registration' => [
                'credentials-description' => '您的賬户已創建。您的賬户詳細信息如下：',
                'description' => '您的帳户已成功創建，您可以使用電子郵件地址和密碼憑據登入。登入後，您將能夠訪問其他服務，包括查看過去的訂單、心願清單和編輯您的帳户信息。',
            ...
            'reminder' => [
                'already-paid' => '如果您已經付款，請忽略此消息。',
                'invoice-overdue' => '這是一個友好的提醒，您的發票已逾期。請儘快付款。',
                'subject' => '發票提醒',
            ],
        ],

        'contact-us' => [
            'contact-from' => '通過網站聯繫表格',
            'reply-to-mail' => '請回復此電子郵件。',
            'reach-via-phone' => '或者，您可以通過電話聯繫我們：',
            'inquiry-from' => '來自的查詢',
            'to' => '聯繫',
        ],
        ...
        'orders' => [
            ...
            'refunded' => [
                'greeting' => '已啓動訂單 :order_id，下單時間 :created_at 的退款',
                'subject' => '新退款確認',
                'summary' => '退款摘要',
                'title' => '訂單已退款！',
            ],
    ...
    'rma' => [
        ...
        'response' => [
            ...
            'create-success' => '請求已成功創建。',
            'creation-error' => '無法更新 RMA 狀態，因為尚未為此訂單創建發票。',
